...
class ESPNetV1(nn.Layer):
    def __init__(self,
        ...
        self.out_proj = ConvBNPReLU(16 + in_channels + num_classes, num_classes,
                                    3, 1)
    ...
    def forward(self, x):
        # shape [N, 19, H, W]  [N, 131, H, W]  [N, C, H, W]
        feat1, feat2, feat3 = self.encoder(x)
...
class PoolDown(nn.Layer):
    def __init__(self, down_sampling_times):
        ...
        self.pool = nn.Sequential(*[
            ...
            for i in range(down_sampling_times)
        ])

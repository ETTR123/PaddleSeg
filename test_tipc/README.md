...
├── configs/  # 配置文件目录
    ├── bisenetv1   # encnet_small模型的测试配置文件目录
        ...
        ├── bisenetv1_cityscapes_1024x512_160k.yml
├── results/   # 预测结果
...
# 功能：准备数据
# 格式：bash + 运行脚本 + 参数1: 配置文件选择 + 参数2: 模式选择
bash test_tipc/prepare.sh ./test_tipc/configs/bisenetv1/train_infer_python.txt 'lite_train_lite_infer'
# 功能：运行测试
# 格式：bash + 运行脚本 + 参数1: 配置文件选择 + 参数2: 模式选择
bash test_tipc/test_train_inference_python.sh ./test_tipc/configs/bisenetv1/train_infer_python.txt 'lite_train_lite_infer'
```
